package com.example.lenovo.application_1214.game.view;
...
import com.example.lenovo.application_1214.game.bean.GameItem;
import com.example.lenovo.application_1214.game.utils.Constances;
import com.example.lenovo.application_1214.game.utils.ScreenUtils;
...
public class GameView extends GridLayout implements View.OnTouchListener {
    ...
    private void checkCompleted() {
        ...
        if (result == 0) {//游戏失败
            if (Config.SCORE > mHighScore) {//记录最高分数
                ...
                GameMainActivity.getMainActivity().setScore(Config.SCORE, 1);
                Config.SCORE = 0;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
            builder.setTitle("Game Over")
                    .setPositiveButton("Again", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            //重新开始
                            startGame();
                            GameMainActivity.getMainActivity().setScore(Config.SCORE, 0);
                        }
                    }).create().show();
            Config.SCORE = 0;
            ...
            builder.setTitle("Mission Accomplished")
                    ...
                    .setNegativeButton("Continue", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            GameMainActivity.getMainActivity().setGoal(mTarget);
                        }
                    }).create().show();
        }
    }
    ...
    public void revertGame() {
        ...
        if (sum != 0) {
            GameMainActivity.getMainActivity().setScore(mScoreHistory, 0);
