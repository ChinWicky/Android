...
import com.example.lenovo.application_1214.letter.LetterActivity;
import com.example.lenovo.application_1214.letter.MyLetterActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(RadioGroup group,int checkedId){
                ...
                if (checkedId==letter.getId()){
                    finish();
                    Intent intent = new Intent(FriendActivity.this,LetterActivity.class);
                    startActivity(intent);
                }
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("Friend_Name",result);
                finish();
                startActivity(intent);
                /*Toast.makeText(FriendActivity.this,result,
